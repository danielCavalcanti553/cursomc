...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p4 = new Produto(null,"Mesa de Esritório",80.00);
		...
		categoriaRepository.save(Arrays.asList(cat1,cat2,cat3,cat4,cat5,cat2,cat6,cat7));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","danielsouza553@gmail.com","32132133",TipoCliente.PESSOAFISICA,pe.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("321-313","3123-3123"));
		
		Cliente cli2 = new Cliente(null,"Daniel","daniel.cavalcanti@outlook.com.br","89144828713",TipoCliente.PESSOAFISICA,pe.encode("123"));
			cli2.getTelefones().addAll(Arrays.asList("321-313","3123-3123"));
		...
		Endereco e3 = new Endereco(null, "Rua w" , "231", "Casa", "Bangu", "21332-213", cli1, c2);
		...
		pagamentoRepository.save(Arrays.asList(pagto2,pagto2));
